...
const FX = [
  ...
  { id:'decotext', name:'Deco Text', hint:'big 3D-extruded title with chunky outlines — pachinko / jackpot / gacha 大当り text', on:false, open:false, params:[
    { k:'amount',  label:'Opacity', min:0, max:1, step:.01, def:1, env:1 },
    { k:'text',    label:'Text', type:'text', def:'JACKPOT', ph:'大当り / JACKPOT' },
    { k:'size',    label:'Size', min:.3, max:3, step:.05, def:1.4 },
    { k:'font',    label:'Font', type:'select', def:0, options:[[0,'Sans Black'],[1,'Rounded'],[2,'Serif'],[3,'Condensed']] },
    { k:'fill',    label:'Fill', type:'select', def:0, options:[[0,'Gold'],[1,'Rainbow'],[2,'Chrome'],[3,'White'],[4,'Fire'],[5,'Candy']] },
    { k:'depth',   label:'3D Depth', min:0, max:1, step:.01, def:.5 },
    { k:'outline', label:'Outline', min:0, max:1, step:.01, def:.5 },
    { k:'outcol',  label:'Outline Colour', type:'select', def:0, options:[[0,'Black'],[1,'White'],[2,'Gold'],[3,'Red']] },
    { k:'tilt',    label:'Tilt', min:-25, max:25, step:1, def:-8 },
    { k:'shine',   label:'Shine', min:0, max:1, step:.01, def:.6 },
    { k:'bounce',  label:'Bounce', min:0, max:1, step:.01, def:.3 },
    { k:'cx',      label:'Pos X', min:0, max:1, step:.01, def:.5 },
    { k:'cy',      label:'Pos Y', min:0, max:1, step:.01, def:.5 },
  ]},
...
const FX_GROUPS = [
  ...
  ['Film / Display',        ['film','crt','hud','decotext','halftone']],
