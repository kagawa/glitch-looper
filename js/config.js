...
const PRESETS = {
  ...
  'Degauss':     { vhs:{on:1,aberration:4,scanline:0,bleed:2,tracking:.1,wobble:1}, glitch:{on:0}, noise:{on:1,grain:.06,flicker:.05}, color:{on:1,saturate:1.25,contrast:1.1,hue:0,tint:.03,vignette:.35}, degauss:{on:1,amount:.85,sway:.7,freq:5,color:.9,curve:1,rate:2}, crt:{on:1,amount:0.46,round:.4,corner:.55,frame:.09,mask:1,phosphor:.6,scan:.4,converge:.35,glow:.4} },
  ...
  'Broken TV':   { vhs:{on:1,aberration:6,scanline:.45,bleed:2,tracking:.9,wobble:8}, glitch:{on:1,amount:.2,slices:18,shift:20,rgb:5}, noise:{on:1,grain:.35,flicker:.3}, color:{on:1,saturate:.7,contrast:1.15,hue:0,tint:0,vignette:.45}, roll:{on:1,hspeed:0,hstep:0,vspeed:.35,band:.6}, crt:{on:1,amount:0.46,round:.45,corner:.5,frame:.07,mask:2,phosphor:.45,scan:.4,converge:.4,glow:.3}, sync:{on:1,hsync:0,flag:0.45,contact:0.5}, synctear:{on:1,amount:.55,tears:3,shift:26,delay:2,rate:5,edge:0}, interlace:{on:1,amount:.7,delay:2,thick:1,swap:0}, motion:{on:1,mode:4,depth:.6,rate:6} },
  // ---- Glitch ----
  'Digital Decay':{ vhs:{on:1,aberration:4,scanline:.15,bleed:1,tracking:.2,wobble:2}, glitch:{on:1,amount:.45,slices:22,shift:30,rgb:10}, noise:{on:1,grain:.1,flicker:.05}, color:{on:0}, compress:{on:1,amount:.5,chroma:.5,ring:.6,block:8}, databend:{on:1,amount:.6,skew:.5,scramble:.35,speed:2} },
  'Datamosh':    { vhs:{on:0}, glitch:{on:0}, noise:{on:1,grain:.08,flicker:0}, color:{on:1,saturate:1.3,contrast:1.1,hue:0,tint:0,vignette:.2}, mosh:{on:1,intensity:.75,blocks:.65,bloom:3,sort:.55,chaos:.85,rate:12}, motion:{on:1,mode:1,depth:.6,rate:3} },
  ...
  'Dead Stream': { noise:{on:1,grain:.82,size:1,type:1,flicker:.88,_seq:[0,0,0,0,0,0,0,0]}, compress:{on:1,amount:.38,chroma:.17,ring:.3,soft:.45,block:16}, ghost:{on:1,amount:.12,offset:22,echoes:2,pre:.3,drift:0,rate:1}, melt:{on:1,amount:.07,mode:0,width:1,spread:.5,curve:4,rate:2}, stale:{on:1,amount:.6,block:16,age:6,steps:2,gop:30,rate:4}, chroma:{on:1,amount:.7,delay:5,mode:0} },
  ...
  'Roll Break':  { vhs:{on:1,aberration:6,scanline:.3,bleed:2,tracking:.6,wobble:4}, glitch:{on:1,amount:.18,slices:16,shift:18,rgb:6}, noise:{on:1,grain:.15,flicker:.12}, color:{on:0}, roll:{on:1,hspeed:.3,hstep:0,vspeed:1.2,band:.75}, sync:{on:1,hsync:0,flag:.4,contact:.15}, film:{on:0}, mosh:{on:0} },
  // ---- Horror ----
  ...
  'Red Room':    { vhs:{on:1,aberration:7,scanline:.35,bleed:2,tracking:.4,wobble:3}, glitch:{on:1,amount:.15,slices:14,shift:16,rgb:8}, noise:{on:1,grain:.25,flicker:.55}, color:{on:1,saturate:1.3,contrast:1.4,hue:-120,tint:.1,vignette:.7}, motion:{on:1,mode:2,depth:.7,rate:6}, synctear:{on:1,amount:.5,tears:3,shift:26,delay:2,rate:5,edge:0}, chroma:{on:1,amount:.5,delay:4,mode:0} },
  ...
  'Camcorder':   { vhs:{on:1,aberration:5,scanline:.25,bleed:3,tracking:.3,wobble:6,wobmode:4}, glitch:{on:0}, noise:{on:1,grain:.2,flicker:.12}, color:{on:1,saturate:1.1,contrast:1.05,hue:0,tint:.1,vignette:.4}, ghost:{on:1,amount:.25,offset:9,echoes:1,pre:0,drift:0,rate:1}, hud:{on:1,layout:3,size:1,opacity:.9} },
  ...
  'Bad Reception':{ vhs:{on:1,aberration:6,scanline:0,bleed:2,tracking:.3,wobble:3}, glitch:{on:0}, noise:{on:1,grain:.35,flicker:.2}, color:{on:1,saturate:.75,contrast:1.1,hue:0,tint:0,vignette:.45}, ghost:{on:1,amount:.6,offset:26,echoes:2,pre:.4}, herring:{on:1,amount:.5,freq:7,speed:3}, hum:{on:1,amount:.3,width:.4,speed:2}, crt:{on:1,amount:0.42,round:.35,corner:.5,frame:.08,mask:1,phosphor:.4,scan:.35,converge:.3,glow:.3}, sync:{on:1,hsync:0,flag:0.25,contact:0.2} },
...
const PRESET_GROUPS = [
  ['Analog / Camera',      ['VHS Tape','8mm Film','CRT','Security Cam','Camcorder','Bad Reception','Broken TV','Roll Break','Degauss']],
  ...
  ['Dream / Light',        ['Pastel Dream','Angelcore','Fairy Dust','Hologram','Oil Slick','Aqua Glass','Sunwashed','Teal & Peach']],
  ['Psychedelic / Spatial',['Kaleidoscope','Trip','Wormhole','Heat Haze','Underwater','Fisheye Cam','Acid']],
