...
const PRESETS = {
  ...
  'CRT':         { vhs:{on:1,aberration:5,scanline:0,bleed:2,tracking:.1,wobble:1}, glitch:{on:0}, noise:{on:1,grain:.1,flicker:.08}, color:{on:1,saturate:1.2,contrast:1.1,hue:0,tint:.05,vignette:.35}, crt:{on:1,amount:0.49,round:.5,corner:.5,frame:.08,mask:2,phosphor:.5,scan:.5,converge:.3,glow:.35}, sync:{on:1,hsync:0,flag:0.15,contact:0.12} },
  'Trinitron':   { vhs:{on:1,aberration:4,scanline:0,bleed:2,tracking:.05,wobble:1}, glitch:{on:0}, noise:{on:1,grain:.05,flicker:.04}, color:{on:1,saturate:1.25,contrast:1.12,hue:0,tint:.03,vignette:.3}, film:{on:0}, roll:{on:0}, mosh:{on:0}, crt:{on:1,amount:0.39,round:.35,corner:.45,frame:.09,mask:1,phosphor:.6,scan:.45,converge:.2,glow:.4} },
  'Dead Channel':{ vhs:{on:1,aberration:7,scanline:0,bleed:2,tracking:.6,wobble:5}, glitch:{on:0}, noise:{on:1,grain:.3,flicker:.35}, color:{on:1,saturate:.85,contrast:1.2,hue:0,tint:-.05,vignette:.5}, film:{on:0}, roll:{on:0}, mosh:{on:0}, crt:{on:1,amount:0.46,round:.4,corner:.55,frame:.1,mask:2,phosphor:.5,scan:.4,converge:.5,glow:.3}, sync:{on:1,hsync:0.35,flag:0.55,contact:0.7}, motion:{on:1,mode:4,depth:.6,rate:5} },
  ...
  'Degauss':     { vhs:{on:1,aberration:4,scanline:0,bleed:2,tracking:.1,wobble:1}, glitch:{on:0}, noise:{on:1,grain:.06,flicker:.05}, color:{on:1,saturate:1.2,contrast:1.1,hue:0,tint:.03,vignette:.35}, film:{on:0}, roll:{on:0}, mosh:{on:0}, degauss:{on:1,amount:.7,sway:.6,freq:4,color:.7,curve:1,rate:2}, crt:{on:1,amount:0.46,round:.4,corner:.5,frame:.09,mask:1,phosphor:.5,scan:.4,converge:.25,glow:.35} },
  ...
  'Broken TV':   { vhs:{on:1,aberration:6,scanline:.45,bleed:2,tracking:.9,wobble:8}, glitch:{on:1,amount:.2,slices:18,shift:20,rgb:5}, noise:{on:1,grain:.35,flicker:.3}, color:{on:1,saturate:.7,contrast:1.15,hue:0,tint:0,vignette:.45}, roll:{on:1,hspeed:0,hstep:0,vspeed:.35,band:.6}, crt:{on:1,amount:0.46,round:.45,corner:.5,frame:.07,mask:2,phosphor:.45,scan:.4,converge:.4,glow:.3}, sync:{on:1,hsync:0,flag:0.45,contact:0.5}, motion:{on:1,mode:4,depth:.6,rate:6} },
  // ---- Glitch ----
  ...
  'Analog TV':   { vhs:{on:1,aberration:5,scanline:0,bleed:2,tracking:.15,wobble:2}, glitch:{on:0}, noise:{on:1,grain:.08,flicker:.06}, color:{on:1,saturate:1.2,contrast:1.1,hue:0,tint:.04,vignette:.35}, film:{on:0}, roll:{on:0}, mosh:{on:0}, dotcrawl:{on:1,amount:.5,size:2,speed:6}, crt:{on:1,amount:0.44,round:.4,corner:.5,frame:.09,mask:1,phosphor:.55,scan:.45,converge:.25,glow:.35}, sync:{on:1,hsync:0,flag:0.15,contact:0.1}, hud:{on:1,layout:5,color:0,size:1,opacity:.95} },
  ...
  // ---- Lens / FX ----
  'Peephole':    { vhs:{on:1,aberration:4,scanline:.3,bleed:2,tracking:.1,wobble:2}, glitch:{on:0}, noise:{on:1,grain:.18,flicker:.08}, color:{on:1,saturate:.9,contrast:1.1,hue:0,tint:.05,vignette:.2}, crt:{on:1,amount:0.81,round:.6,corner:.9,frame:.15,mask:0,phosphor:0,scan:0,converge:0,glow:0} },
...
const PRESET_GROUPS = [
  ...
  ['Psychedelic / Spatial',['Kaleidoscope','Trip','Wormhole','Heat Haze','Underwater','Peephole','Fisheye Cam','Acid']],
  ['Print / Material',     ['Newsprint','Risograph','Manga','Papercraft','Metal','Relief','LED Board','Retro Game','Arcade']],
];
