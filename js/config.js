...
const PRESETS = {
  ...
  // ---- Lens / FX ----
  'Trip':        { vhs:{on:1,aberration:8,scanline:.1,bleed:4,tracking:.1,wobble:3}, glitch:{on:0}, noise:{on:1,grain:.05,flicker:.04}, color:{on:1,saturate:1.6,contrast:1.05,hue:90,tint:0,vignette:.35}, warp:{on:1,amp:5,freq:6,speed:2}, rainbow:{on:1,amount:.5,speed:2,angle:45,blend:2}, feedback:{on:1,amount:.4,zoom:.88,copies:5,feather:.4,flow:1,rotate:12,speed:0,pulse:.4}, bloom:{on:1,amount:.45,size:10,glow:.3}, motion:{on:1,mode:2,depth:.6,rate:3} },
  ...
  'Heat Haze':   { vhs:{on:1,aberration:5,scanline:.1,bleed:3,tracking:.1,wobble:2}, glitch:{on:0}, noise:{on:1,grain:.07,flicker:.05}, color:{on:1,saturate:1.15,contrast:1.05,bright:1.08,hue:15,tint:.25,vignette:.4}, warp:{on:1,amp:6,freq:4,speed:2}, bloom:{on:1,amount:.35,size:14,glow:.55}, leak:{on:1,amount:.45,tone:0,pos:2,size:.6,drift:.6} },
  'Wormhole':    { vhs:{on:1,aberration:10,scanline:.15,bleed:4,tracking:.1,wobble:2}, glitch:{on:0}, noise:{on:1,grain:.06,flicker:.03}, color:{on:1,saturate:1.5,contrast:1.05,hue:-60,tint:0,vignette:.5}, feedback:{on:1,amount:.6,zoom:.84,copies:6,feather:.35,flow:1,rotate:20,speed:0,pulse:.5}, iris:{on:1,amount:.4,angscale:.5,lumascale:1.3,speed:2,edge:0}, rainbow:{on:1,amount:.35,speed:2,angle:60,blend:0} },
  ...
  // ---- Hype (dopamine) ----
  'Jackpot':     { color:{on:1,saturate:1.25,contrast:1.12,bright:1.05,hue:0,tint:.08,vignette:.18}, gold:{on:1,amount:.95,shine:.85,speed:2,angle:45,tone:0}, burst:{on:1,amount:.55,lines:.6,reach:.7,spin:.15,tone:0,blend:0}, sparkle:{on:1,amount:.9,density:.55,size:.5,speed:1,shape:4,tone:0}, leak:{on:1,amount:.35,tone:1,pos:1,size:.6,drift:.4}, bloom:{on:1,amount:.35,size:10,glow:.3} },
