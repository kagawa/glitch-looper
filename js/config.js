...
const FX = [
  ...
  { id:'decotext', name:'Edge Extrude', hint:'edge-detect the image then repeat its edges along a light direction — pachinko/jackpot-style 3D extrusion of the image contours', on:false, open:false, params:[
    { k:'amount',   label:'Amount', min:0, max:1, step:.01, def:.9, env:1, envd:1 },
    { k:'depth',    label:'3D Depth', min:0, max:1, step:.01, def:.55, env:1 },
    { k:'outline',  label:'Outline Strength', min:0, max:1, step:.01, def:.8 },
    { k:'outcol',   label:'Outline Colour', type:'select', def:0, options:[[0,'Black'],[1,'White'],[2,'Gold'],[3,'Red']] },
    { k:'bevel',    label:'Bevel Highlight', min:0, max:1, step:.01, def:.35 },
    { k:'thresh',   label:'Edge Threshold', min:0, max:1, step:.01, def:.18 },
