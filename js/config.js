...
const PRESETS = {
  ...
  // ---- Horror ----
  'Cursed Tape': { vhs:{on:1,aberration:10,scanline:.5,bleed:3,tracking:.85,wobble:9}, glitch:{on:1,amount:.18,slices:20,shift:18,rgb:6}, noise:{on:1,grain:.4,flicker:.45}, color:{on:1,saturate:.55,contrast:1.35,hue:-25,tint:-.2,vignette:.75}, film:{on:1,dust:.35,scratch:.35,sepia:0,burn:.35}, roll:{on:1,hspeed:0,hstep:0,vspeed:.15,band:.4}, chroma:{on:1,amount:.6,delay:5,mode:0}, motion:{on:1,mode:4,depth:.7,rate:5} },
  ...
  'Red Room':    { vhs:{on:1,aberration:7,scanline:.35,bleed:2,tracking:.4,wobble:3}, glitch:{on:1,amount:.15,slices:14,shift:16,rgb:8}, noise:{on:1,grain:.25,flicker:.55}, color:{on:1,saturate:1.3,contrast:1.4,hue:-120,tint:.1,vignette:.7}, bloom:{on:1,amount:.4,size:14,glow:.45}, motion:{on:1,mode:2,depth:.7,rate:6}, synctear:{on:1,amount:.5,tears:3,shift:26,delay:2,rate:5,edge:0}, chroma:{on:1,amount:.5,delay:4,mode:0} },
  'Meltdown':    { vhs:{on:1,aberration:6,scanline:.2,bleed:2,tracking:.25,wobble:3}, glitch:{on:0}, noise:{on:1,grain:.15,flicker:.15}, color:{on:1,saturate:.7,contrast:1.2,hue:-30,tint:-.1,vignette:.6}, warp:{on:1,amp:4,freq:5,speed:1}, melt:{on:1,amount:.55,width:10}, chroma:{on:1,amount:.5,delay:4,mode:1}, motion:{on:1,mode:1,depth:.6,rate:2} },
  // ---- Vivid ----
  ...
  'Neon':        { vhs:{on:1,aberration:12,scanline:.2,bleed:3,tracking:.1,wobble:2}, glitch:{on:0}, noise:{on:1,grain:.08,flicker:.05}, color:{on:1,saturate:1.9,contrast:1.25,bright:.95,hue:60,tint:-.2,vignette:.55}, bloom:{on:1,amount:.55,size:14,glow:.3}, starf:{on:1,amount:.5,thresh:.65,length:.4,rays:0,angle:45} },
...
const PRESET_GROUPS = [
  ...
  ['Print / Material',     ['Newsprint','Risograph','Manga','Papercraft','Metal','Relief','LED Board','Retro Game']],
